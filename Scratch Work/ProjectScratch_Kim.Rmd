...
The RSXFSN data series measures the dollar value of sales and is reported on millions of dollars. This data is not seasonally adjusted and is released monthly. The period of observation for this project spans a 10 year period from January 2014 to May 2024, totalling 126 observations. 
...
```
The data shows clear nonstationarity. Therefore, we proceed with differencing measures to achieve stationarity.
...
#### Fitting the GARCH Model to log-transformed and differenced data (DO NOT CALL)
```{r}
# # Check convergence
...
#### Fitting the GARCH Model to seasonally differenced data plus an additional order of differencing (CALL THIS INSTEAD)
```{r}
